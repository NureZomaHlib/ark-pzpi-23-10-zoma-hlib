...
//Поганий
var name // тип не вказаний
name = null // може бути NullPointerException
var age: Int? = null
val years = age!! // аварійне розіменування

//Хороший
val name: String? = null // явно вказаний nullable-тип
val age: Int? = null
val years = age ?: 0 // безпечна заміна значенням за
замовчуванням
val length = name?.length // безпечний виклик
